...
class ConsultaControllerTest {
    ...
    @Autowired
    private JacksonTester<DadosAgendamentoConsulta> testerAgendamentoConsulta;

    @Autowired
    private JacksonTester<DadosDetalhamentoConsulta> testerDetalhamentoConsulta;
    ...
    void agendarCenario2() throws Exception {
        ...
        var response = mvc
                .perform(
                        post("/consultas")
                                ...
                                .content(testerAgendamentoConsulta.write(
        ...
        var jsonEsperado = testerDetalhamentoConsulta.write(dadosDetalhamento).getJson();
